...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemPrompt = `You are Bea, a clinical health analysis AI for AlagApp. Generate medically accurate health reports based on user data.
...
1. REPORT HEADER - Title, date range, generated by Bea AI
...
============================================================
Report generated by Bea AI - AlagApp Health Assistant`;
}